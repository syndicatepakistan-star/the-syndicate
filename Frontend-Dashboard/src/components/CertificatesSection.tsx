      ...
      {isPreviewOpen ? (
        ...
        >
          <button
            type="button"
            onClick={() => setIsPreviewOpen(false)}
            className="absolute right-3 top-3 z-[130] rounded-md border border-cyan-300/50 bg-black/60 px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.12em] text-cyan-100 hover:bg-cyan-950/80"
          >
            Close
          </button>
          <div
            onClick={(event) => event.stopPropagation()}
            className="relative flex h-auto max-h-[100dvh] w-full max-w-[min(760px,96vw)] flex-col overflow-hidden rounded-[22px] border border-cyan-200/90 bg-[#070a1a]"
            style={{
              ...
              <div className="relative flex flex-col overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col gap-2 px-2 pb-2 pt-4 text-cyan-100 sm:gap-2.5 sm:px-3 sm:pb-3 sm:pt-5">
                  ...
                  <div className="shrink-0 text-center">
                    <h2 className="text-[clamp(1.35rem,4.5vh,2.625rem)] font-semibold uppercase leading-[0.95] tracking-[0.04em] text-cyan-100 sm:tracking-[0.06em]" style={{ textShadow: '0 0 18px rgba(56,189,248,0.95), 0 0 30px rgba(249,115,22,0.45)' }}>
                      SYN TOKEN
                    </h2>
                    <p className="mt-0.5 text-[9px] uppercase tracking-[0.22em] text-cyan-100/85 sm:text-[11px] sm:tracking-[0.3em]">of Achievement</p>
                  </div>

                  <div className="shrink-0 rounded-xl border border-fuchsia-300/55 bg-cyan-400/5 p-2 shadow-[0_0_18px_rgba(56,189,248,0.24)] sm:p-3 [clip-path:polygon(10px_0,calc(100%-10px)_0,100%_10px,100%_calc(100%-10px),calc(100%-10px)_100%,10px_100%,0_calc(100%-10px),0_10px)]">
                    <p className="text-[10px] uppercase tracking-[0.2em] text-cyan-100/80">Token Owner</p>
                    <h3 className="mt-0.5 text-[clamp(1.25rem,5vh,2.25rem)] font-semibold uppercase tracking-[0.04em] text-[#fdd02f] sm:tracking-[0.08em]" style={{ textShadow: '0 0 16px rgba(253,208,47,0.45)' }}>
                      Rick Ross
                    </h3>
                    <p className="mt-1 text-[10px] uppercase tracking-[0.1em] text-cyan-100/75 sm:text-[12px] sm:tracking-[0.18em]">AI Automations & Digital Mastery</p>
                  </div>
                  ...
                  <div className="shrink-0 rounded-lg border border-fuchsia-300/45 bg-black/20 px-2.5 py-2 sm:px-3 sm:py-2.5">
                    ...
                    <p className="mt-1 text-[clamp(11px,1.55vh,15px)] leading-snug text-cyan-50/95 sm:leading-relaxed">
                  ...
                  <div className="shrink-0 flex flex-col items-stretch gap-3 pb-1 sm:flex-row sm:items-center sm:justify-center sm:gap-6">
                    <div className="relative flex flex-col items-center justify-center sm:flex-initial">
                      <div className="relative flex h-[clamp(4.5rem,11vh,8.5rem)] w-[clamp(4.5rem,11vh,8.5rem)] items-center justify-center">
                      ...
                      <p className="mt-2 text-center text-[9px] uppercase tracking-[0.2em] text-cyan-100/80 sm:text-[10px] sm:tracking-[0.24em]">Syndicate Credential Token</p>
                    ...
                    <div className="flex flex-col items-center sm:items-start">
                      ...
                      <p className="mt-1.5 max-w-[140px] text-center font-mono text-[8px] leading-tight text-cyan-200/55 sm:max-w-[160px]">Registry link encoded for demo preview.</p>
                    </div>
                  </div>
