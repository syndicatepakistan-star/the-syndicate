...
/** Use a new filename (e.g. money-mastery-v2.jpg) when replacing art — Next/Image disallows `?v=` on local assets. */
export const OFFER_PLAN_THUMB_MONEY_MASTERY =
  "/assets/programs/offers/money-mastery-v2.jpg";
export const OFFER_PLAN_THUMB_THE_KNIGHT = "/assets/theknight.jpg";
