...
const AGENTIC_ROWS: VaultCourseRow[] = [
  ...
  ["Set up Google Credentials in n8n", "set up google credentials.jpg"],
  ...
  ["4 Claude Code Hacks To Make Any Website Look Pro", "4 claude code hacks.jpg"],
...
const AI_CONTENT_ROWS: VaultCourseRow[] = [
  ...
  ["New YouTube Policy ENDS These Faceless YouTube Channels", "youtube policy.jpg"],
  ["Start YouTube Automation in 2026 (Step By Step) NO FACE", "start youtube automation.jpg"],
  ["Build Faceless YouTube Channels Using Just ONE AI Tool (Genspark AI)", "genspark ai.jpg"],
  ["Build a VIRAL AI Movie Channel Using Only AI Tools", "movie channel.jpg"],
  ["Create Viral High RPM Finance Videos Using AI (Full Blueprint)", "rpm finance.jpg"],
  ["Make VIRAL 3D Animated Videos Using FREE AI Tools (FULL COURSE)", "3d animated videos.jpg"],
  ["Build a Viral AI Influencer (AI Instagram Models)", "aitana lopez instagram.jpg"],
  ["Make a VIRAL AI Documentary Channel Using FREE Tools (FULL COURSE)", "ai documentory.jpg"],
  ["Build a VIRAL Philosophy Channel Using FREE AI Tools (FULL COURSE)", "philosphy channel.jpg"],
  ["Use AI to Build a VIRAL Prehistoric Faceless Channel (Full Course)", "perhistoric channel.jpg"],
  ["Clone a VIRAL 3D Documentary Channel Using AI (Full Course)", "cloned 3d.jpg"],
  ["Make VIRAL Geography Shorts Using Only AI (FULL GUIDE)", "geography.jpg"],
  ["Build a Viral Universe Documentary Channel Using Only AI (Step by Step!)", "universe channel.jpg"],
  ["ACTUALLY Go Viral", "5000 studied.jpg"],
  ["50 Easy Faceless Niches", "50 niches.jpg"],
  ["Create 1,000 YouTube Shorts Using FREE AI - Free Auto Shorts in Bulk", "1000 shorts.jpg"],
  ["Crack The NEW Algorithm", "70+ crack algo.jpg"],
  ["These Faceless YouTube Niches Are Now BANNED", "banned.jpg"],
  ["Write Faceless YouTube Scripts That Get 100s Of Millions Of Views", "100 millions views.jpg"],
  ...
  ["Create Motion Graphics videos in MINUTES with AI", "motion graphics.jpg"],
  ["Viral Faceless Stickman POV", "stickan pov.jpg"],
  ["The Secret NotebookLM Workflow Every YouTuber Needs!", "youtuber need!.jpg"],
  ["Create viral 3D documentary videos using ai(FERN 3D STYLE)", "fern 3d style.jpg"],
