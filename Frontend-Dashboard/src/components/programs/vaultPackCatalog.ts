...
const AGENTIC_ROWS: VaultCourseRow[] = [
  ...
  ["Claude Code + Consensus for INSANE $50k+ App Ideas", "insane 50k.png"],
  ["Is Claude Code Better than n8n", "claude better.png"],
  ["Claude Code Memory Change", "claude memory.png"],
  ["Claude Cowork Automations", "claude cowork.jpg"],
  ["Scrap Any Website with N8N", "scrap website.jpg"],
  ["Set up Google Credentials in n8n", "set up google credentials.png"],
  ...
  ["4 Claude Code Hacks To Make Any Website Look Pro", "4 claude code hacks.png"],
  ...
  ["Claude Cowork Marketing", "claude marketing.png"],
  ...
  ["Alternatives to N8N in 2026", "stop n8n.png"],
...
const AI_CONTENT_ROWS: VaultCourseRow[] = [
  ...
  ["New YouTube Policy ENDS These Faceless YouTube Channels", "youtube policy.png"],
  ["Start YouTube Automation in 2026 (Step By Step) NO FACE", "start youtube automation.png"],
  ["Build Faceless YouTube Channels Using Just ONE AI Tool (Genspark AI)", "genspark ai.png"],
  ["Build a VIRAL AI Movie Channel Using Only AI Tools", "movie channel.png"],
  ["Create Viral High RPM Finance Videos Using AI (Full Blueprint)", "rpm finance.png"],
  ["Make VIRAL 3D Animated Videos Using FREE AI Tools (FULL COURSE)", "3d animated videos.png"],
  ["Build a Viral AI Influencer (AI Instagram Models)", "aitana lopez instagram.png"],
  ["Make a VIRAL AI Documentary Channel Using FREE Tools (FULL COURSE)", "ai documentory.png"],
  ["Build a VIRAL Philosophy Channel Using FREE AI Tools (FULL COURSE)", "philosphy channel.png"],
  ["Use AI to Build a VIRAL Prehistoric Faceless Channel (Full Course)", "perhistoric channel.png"],
  ["Clone a VIRAL 3D Documentary Channel Using AI (Full Course)", "cloned 3d.png"],
  ["Make VIRAL Geography Shorts Using Only AI (FULL GUIDE)", "geography.png"],
  ["Build a Viral Universe Documentary Channel Using Only AI (Step by Step!)", "universe channel.png"],
  ["ACTUALLY Go Viral", "5000 studied.png"],
  ["50 Easy Faceless Niches", "50 niches.png"],
  ["Create 1,000 YouTube Shorts Using FREE AI - Free Auto Shorts in Bulk", "1000 shorts.png"],
  ["Crack The NEW Algorithm", "70+ crack algo.png"],
  ["These Faceless YouTube Niches Are Now BANNED", "banned.png"],
  ["Write Faceless YouTube Scripts That Get 100s Of Millions Of Views", "100 millions views.png"],
  ["The Smart Way to Build a Faceless Finance Channel", "nick invests exposed.png"],
  ["New YouTube Shorts Niche That No One Is Doing Yet (And It's Exploding)", "exploding.png"],
  ["Create Motion Graphics videos in MINUTES with AI", "motion graphics.png"],
  ["Viral Faceless Stickman POV", "stickan pov.png"],
  ["The Secret NotebookLM Workflow Every YouTuber Needs!", "youtuber need!.png"],
  ["Create viral 3D documentary videos using ai(FERN 3D STYLE)", "fern 3d style.png"],
  ["Make VIRAL Life Advice Videos Using Only FREE AI Tools", "life advice.png"],
  ["Create Viral inspirational finance Videos with Free AI Tools", "inspirational finance.png"],
  ["Clone ANY YouTube Channel With AI (NotebookLM Hack)", "clone any channel.png"],
].map(([title, image], i) => {
