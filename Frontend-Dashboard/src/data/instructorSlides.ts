...
export type InstructorSlideUnlock =
  | { kind: "playlist"; legacyPlaylistId: number }
  | { kind: "plan"; plan: CheckoutOfferKey };
...
export const INSTRUCTOR_SLIDES: InstructorSlide[] = [
  ...
  },
  {
    ...
    unlock: { kind: "playlist", legacyPlaylistId: 21 },
  },
  {
    ...
    unlock: { kind: "plan", plan: "agentic_ai" },
  },
  {
    ...
    unlock: { kind: "playlist", legacyPlaylistId: 28 },
  },
  {
    ...
    unlock: { kind: "plan", plan: "trading_technical_analysis" },
  },
  {
    ...
    unlock: { kind: "playlist", legacyPlaylistId: 14 },
  },
  {
    ...
    unlock: { kind: "playlist", legacyPlaylistId: 23 },
  },
  {
  ...
  },
  {
    ...
    unlock: { kind: "playlist", legacyPlaylistId: 25 },
  },
  {
  ...
  },
  {
    ...
    unlock: { kind: "playlist", legacyPlaylistId: 13 },
  },
];
