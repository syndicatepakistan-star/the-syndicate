...
Understanding the daily, weekly, and one-hour charts
How to identify support and resistance levels
Finding precise areas for potential market reversals
Recognizing repeating patterns in trading
The importance of focusing on high-probability setups
Insights into trading strategies used by Wall Street traders
...
How to read one-minute charts for patterns
Recognizing bear flags and their meaning
Understanding bull flags and their significance
Identifying rising parallel channels and their outcomes
How price movements relate to bull and bear flags
The importance of support and resistance in trading
Understanding rising wedges and falling wedges
...
Understanding oversold bounces in the market
How to analyze daily, hourly, and minute charts
Identifying support lines for better decision-making
The importance of bullish divergence in trading
Recognizing key indicators like RSI (Relative Strength Index)
Strategies for entering and exiting trades effectively
Real-life examples of falling wedge patterns in action
...
How to identify stocks and assets that have risen sharply
Understanding the concept of higher time frame resistance
Recognizing bearish consolidation in market charts
Using moving averages to analyze price action
Learning about measured moves in rising wedge patterns
Analyzing the relationship between price movement and RSI (Relative Strength Index)
Identifying double top patterns and resistance levels
Understanding the importance of combining wedge patterns with support, resistance, and divergence
...
Learn about the 50 moving average and the 200 moving average
Identify moving averages on different charts, like one-minute and five-minute
Discover how moving averages act as support and resistance
Use moving averages to find breakout points
Analyze charts to spot trends and key levels
Combine moving averages with other tools for stronger trading signals
...
Understanding upsloping and downsloping parallel channels
How to identify pivot highs and lows in price action
Techniques for spotting resistance and support lines
The strategy for trading the rising parallel channel
How to use the RSI indicator to confirm trading signals
Recognizing key patterns like bearish and bullish divergence
Understanding the concept of retracing to previous levels
The significance of multiple trend lines in analysis
Applying the same principles to any stock or index
...
Learn how gap fills create buying and selling pressure
Identify key levels of support and resistance using gaps
Explore the significance of different types of gaps
Analyze market charts to find gaps and their implications
Learn to combine gap analysis with other trading indicators
Practice identifying gap fills in real-time market scenarios
Discover strategies for trading based on gap fills
...
Recognizing smart money and patient money strategies
Analyzing charts to identify breakout points
Learning about bullish and bearish retraces
Spotting patterns on different time frames
Understanding fakeouts and how to avoid them
Observing the influence of the S&P 500 on individual stocks
...
Key concepts of trade execution and risk management
How to determine entry points for trades
Techniques for setting exit points and taking profits
Ways to calculate stop loss levels and when to adjust them
Strategies for adding to your position as a trade develops
Learning to identify support and resistance levels
Understanding how to use market patterns in your trading
Recognizing bullish and bearish divergences for better decisions
...
Understanding chart patterns with real-time examples
How to set entry points and profit targets
Managing stop-loss orders to protect your trades
Adjusting trend lines as market conditions change
Practicing trades using Trading View's replay feature
Analyzing price action and identifying support and resistance levels
Making informed trading decisions based on chart patterns
Understanding how to read market indicators like RSI
Strategies for maximizing gains and minimizing losses
Learning to recognize bullish and bearish patterns
Developing a disciplined trading approach to enhance profit potential
Final thoughts on combining money management with trading strategies`,
};

const SCALPEL_SLUG_TO_TITLE: Readonly<Record<string, string>> = {
  trading_scalpel_protocol: TRADING_SCALPEL_MODULE_TITLE,
  "the-1-minute-scalpel": TRADING_SCALPEL_MODULE_TITLE,
  "the-scalpel-protocol": TRADING_SCALPEL_MODULE_TITLE,
  trading_scalpel_01: "Chapter 1 — Introduction",
...
export function curatedTradingScalpelDescription(
  ...
  if (slugKey && SCALPEL_SLUG_TO_TITLE[slugKey]) {
    return TRADING_SCALPEL_PROGRAM_DESCRIPTIONS[SCALPEL_SLUG_TO_TITLE[slugKey]];
  }
  const titleKey = title?.trim();
  if (titleKey && TRADING_SCALPEL_PROGRAM_DESCRIPTIONS[titleKey]) {
    return TRADING_SCALPEL_PROGRAM_DESCRIPTIONS[titleKey];
  }
  return undefined;
}
