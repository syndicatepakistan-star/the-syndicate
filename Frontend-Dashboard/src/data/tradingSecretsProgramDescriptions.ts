...
const SECRETS_SLUG_TO_KEY: Readonly<Record<string, string>> = {
  trading_master_secrets: "__module_pack__",
  trading_secrets_01: "The Confirmation Signal",
  trading_secrets_02: "Drawing Proper Trendlines",
  trading_secrets_03: "Scene of the Crime Retrace",
  trading_secrets_04: "Measured Move",
  trading_secrets_05: "Three Tail Theory",
  trading_secrets_06: "Trading Parallels",
  trading_secrets_07: "Major vs Minor Support and Resistance",
  trading_secrets_08: "Multi-Hit Methodology",
  trading_secrets_09: "Trading the Hit and Kiss of a Level",
  trading_secrets_10: "Macro Versus Micro Patterns",
  trading_secrets_11: "Bull and Bear Flag Flips",
  trading_secrets_12: "Trading RSI Divergences",
  trading_secrets_13: "Time Counts",
  trading_secrets_14: "The Biggest Moves Come from Failed Moves",
  trading_secrets_15: "Time Value of a Level",
  trading_secrets_16: "Fine-Tuning Entry Points",
  trading_secrets_17: "Goals and Expectations",
};

const SECRETS_TITLE_TO_KEY: Readonly<Record<string, string>> = {
  [TRADING_SECRETS_MODULE_TITLE]: "__module_pack__",
  "the confirmation signal": "The Confirmation Signal",
  "drawing proper trendlines": "Drawing Proper Trendlines",
  "scene of the crime retrace": "Scene of the Crime Retrace",
  "measured move": "Measured Move",
  "measured moves": "Measured Move",
  "three tail theory": "Three Tail Theory",
  "three trail theory": "Three Tail Theory",
  "trading parallels": "Trading Parallels",
  "major vs minor support and resistance": "Major vs Minor Support and Resistance",
  "multi hit methodology": "Multi-Hit Methodology",
  "trading the hit and kiss of a level": "Trading the Hit and Kiss of a Level",
  "macro versus micro patterns": "Macro Versus Micro Patterns",
  "macro vs micro patterns": "Macro Versus Micro Patterns",
  "bull and bear flag flips": "Bull and Bear Flag Flips",
  "trading rsi divergences": "Trading RSI Divergences",
  "time counts": "Time Counts",
  "the biggest moves come from failed moves": "The Biggest Moves Come from Failed Moves",
  "time value of a level": "Time Value of a Level",
  "fine tuning entry points": "Fine-Tuning Entry Points",
...
export function curatedTradingSecretsDescription(
  ...
  if (slugKey && SECRETS_SLUG_TO_KEY[slugKey]) {
    return TRADING_SECRETS_PROGRAM_DESCRIPTIONS[SECRETS_SLUG_TO_KEY[slugKey]];
  }
  const titleKey = normalizeTitleKey(title ?? "");
  if (titleKey && SECRETS_TITLE_TO_KEY[titleKey]) {
    return TRADING_SECRETS_PROGRAM_DESCRIPTIONS[SECRETS_TITLE_TO_KEY[titleKey]];
  }
  return undefined;
}
