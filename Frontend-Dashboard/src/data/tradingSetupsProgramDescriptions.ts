...
const SETUPS_SLUG_TO_KEY: Readonly<Record<string, string>> = {
  trading_master_setups: "__module_pack__",
  trading_setups_01: "Introduction",
  trading_setups_02: "Setups of a Master Trader — Lesson",
  trading_setups_03: "Bull and Bear Flag Setups",
  trading_setups_04: "Cup and Handle Setups",
  trading_setups_05: "Mature Versus Immature Patterns and Setups",
  trading_setups_06: "Megaphone and Consolidation Patterns",
  trading_setups_07: "Downsloping and Upsloping Channels",
  trading_setups_08: "Double Tops and Double Bottoms",
  trading_setups_09: "Triple Tops and Beyond",
  trading_setups_10: "The M-A Pattern",
  trading_setups_11: "The W-V Pattern",
  trading_setups_12: "Gaps and Gap Fills",
  trading_setups_13: "The Power of the Move",
  trading_setups_14: "Trading the Golden and Death Cross Setup",
  trading_setups_15: "Trading Doji Candle Setups",
  trading_setups_16: "Topping and Bottoming Tail Setups",
  trading_setups_17: "Engulfing Candle Setups",
  trading_setups_18: "Wise Words for Master Setups",
};

const SETUPS_TITLE_TO_KEY: Readonly<Record<string, string>> = {
  [TRADING_SETUPS_MODULE_TITLE]: "__module_pack__",
  introduction: "Introduction",
  "bull and bear flag setups": "Bull and Bear Flag Setups",
  "cup and handle setups": "Cup and Handle Setups",
  "mature versus immature patterns and setups": "Mature Versus Immature Patterns and Setups",
  "megaphone and consolidation patterns": "Megaphone and Consolidation Patterns",
  "downsloping and upsloping channels": "Downsloping and Upsloping Channels",
  "double tops and double bottoms": "Double Tops and Double Bottoms",
  "triple tops and beyond": "Triple Tops and Beyond",
  "the m a pattern": "The M-A Pattern",
  "the w v pattern": "The W-V Pattern",
  "gaps and gap fills": "Gaps and Gap Fills",
  "the power of the move": "The Power of the Move",
  "trading the golden and death cross setup": "Trading the Golden and Death Cross Setup",
  "trading doji candle setups": "Trading Doji Candle Setups",
  "topping and bottoming tail setups": "Topping and Bottoming Tail Setups",
  "engulfing candle setups": "Engulfing Candle Setups",
  "wise words for master setups": "Wise Words for Master Setups",
};
...
export function curatedTradingSetupsDescription(
  ...
  if (slugKey && SETUPS_SLUG_TO_KEY[slugKey]) {
    return TRADING_SETUPS_PROGRAM_DESCRIPTIONS[SETUPS_SLUG_TO_KEY[slugKey]];
  }
  const titleKey = normalizeTitleKey(title ?? "");
  if (titleKey && SETUPS_TITLE_TO_KEY[titleKey]) {
    return TRADING_SETUPS_PROGRAM_DESCRIPTIONS[SETUPS_TITLE_TO_KEY[titleKey]];
  }
  return undefined;
}
