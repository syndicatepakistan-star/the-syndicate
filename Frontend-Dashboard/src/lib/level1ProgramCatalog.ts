...
export const LEVEL1_SLUG_THUMBNAILS: Record<string, string> = {
  ...
  "level1-model-03": "/assets/programs/cources%20imnages/app-building-vibe-coding.jpg",
  "level1-model-04": "/assets/programs/cources%20imnages/custom-app-blueprint.jpg",
