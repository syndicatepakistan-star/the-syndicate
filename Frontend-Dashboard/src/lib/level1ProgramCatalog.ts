...
export const LEVEL1_SLUG_THUMBNAILS: Record<string, string> = {
  ...
  "level1-model-02": "/assets/programs/cources%20imnages/ai%20automations.jpg",
  "level1-model-03": "/assets/programs/cources%20imnages/flutter-app-building.jpg",
  "level1-model-04": "/assets/programs/cources%20imnages/react.jpg",
  "level1-model-05": "/assets/programs/cources%20imnages/cyber-dystopian-city.jpg",
  "level1-model-06": "/assets/programs/cources%20imnages/unreal%20engine.jpg",
  "level1-model-07": "/assets/programs/cources%20imnages/framer.jpg",
  "level1-model-08": "/assets/programs/cources%20imnages/canvics-to-canva.jpg",
  "level1-model-09": "/assets/programs/cources%20imnages/print%20on%20demand.jpg",
  "level1-model-10": "/assets/programs/cources%20imnages/python.jpg",
  "level1-model-11": "/assets/programs/cources%20imnages/wordpress-blog.jpg",
};
