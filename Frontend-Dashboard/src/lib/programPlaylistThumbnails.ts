...
export const PROGRAM_PLAYLIST_THUMBNAILS: Record<number, string> = {
  ...
  21: courseThumb("app-building-vibe-coding.jpg"),
  22: courseThumb(
  ...
  28: courseThumb("custom-app-blueprint.jpg"),
...
export const CURATED_GLOBE_TILES: readonly CuratedGlobeTile[] = [
  ...
  { src: courseThumb("app-building-vibe-coding.jpg"), alt: "App Building for Business (Vibe Coding)", fileName: "app-building-vibe-coding.jpg", href: programPlaylistDeepLink(21), programId: 21 },
  ...
  { src: courseThumb("custom-app-blueprint.jpg"), alt: "The Custom App Blueprint for Business", fileName: "custom-app-blueprint.jpg", href: programPlaylistDeepLink(28), programId: 28 },
