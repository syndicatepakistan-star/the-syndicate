...
const QUIZ_COURSE_TO_CANONICAL_TITLE: Record<string, string> = {
  // Business models (WEAPON_TO_PLAYLIST) — old quiz keys → new display titles
  "ai automation": "Social Media Content Automation",
  "ai content automation": "Faceless YouTube AI Content Creator Course",
  "n8n ai automation": "AI content Automation for Businesses",
  "building ai agents with claude and anti gravity": "AI content Automation for Businesses",
  "app building using flutter": "App Building for Business (Vibe Coding)",
  "python full course": "Basics Python for Small Business",
  "amazon kdp": "eBook Business Blueprint (Monetize Your Knowledge)",
  "build a real react app": "The Custom App Blueprint for Business",
  "building games using unreal engine": "The Gaming Business Blueprint (Build, Launch, and Sell)",
  ...
  "full canva tutorial": "Graphics Design for Business (Graphics That Convert to Sales)",
